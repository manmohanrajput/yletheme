    ...
    .bar-left {
      ul {
        li {
          ...
          border-left: 1px solid ${({ colors }) => colors.border2};
          padding: 10px 15px;
          margin: 0;
          ...
          &:last-child {
            border-right: 1px solid ${({ colors }) => colors.border2};
          }
      ...
      .emcontact-box {
        ...
        .box-icon {
          ...
          &:before {
            ...
            border-bottom-color: ${({ colors }) => colors.green};
          ...
          &:after {
            ...
            border-width: 10px 18px;
            border-style: solid;
            border-top-color: ${({ colors }) => colors.green};
            border-right-color: transparent;
      ...
      .apply-btn {
        ...
        a {
          ...
          i {
            ...
            background-color: ${({ colors }) => colors.green2};
          }
