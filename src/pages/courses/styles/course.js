      ...
      .course-top-overview {
        ...
        .overviews {
          .author {
            ...
            padding-right: 20px;
            margin-top: -3px;
            border-right: 1px solid ${({ colors }) => colors.border3};
            img {
              float: left;
              max-width: 50px;
              border-radius: 50%;
            ...
            .course-element {
              ...
              .course-item {
                ...
                .course-content {
                  ...
                  ul {
                    li {
                      border-bottom: 1px solid ${({ colors }) => colors.border3};
                      margin-left: 25px;
                      padding: 12px 0;
                      span.play-icon {
                        font-size: 14px;
                        ...
                        i {
                          color: ${({ colors }) => colors.green};
                          border: 1px solid ${({ colors }) => colors.green};
                          font-size: 22px;
                          width: 30px;
                          height: 30px;
                          border-radius: 50%;
    ...
    .single-details-sidbar {
      .course-details-feature {
        ...
        ul.feature-list {
          margin-bottom: 20px;
          li {
            border-top: 1px dashed ${({ colors }) => colors.border3};
            padding: 12px 0;
            font-size: 14px;
            color: ${({ colors }) => colors.black2};
            font-weight: 500;
