            ...
            .login-box {
                ...
                form.form {
                    ...
                    p.form-control.error {
                        input {
                            border: 2px solid ${({ colors }) => colors.red};
                        }
                                ...
                                input[type=checkbox] {
                                    ...
                                    &:checked {
                                        background-color: ${({ colors }) =>
                                          colors.green};
                                        background: ${({ colors }) =>
                                          colors.green} url("data:image/gif;base64,R0lGODlhCwAKAIABAP////3cnSH5BAEKAAEALAAAAAALAAoAAAIUjH+AC73WHIsw0UCjglraO20PNhYAOw==") 2px 2px no-repeat;
                                        border-color : ${({ colors }) =>
                                          colors.green};
                                    }
                                }
